...
import models
import utils
from data_loader import MyDataset, Collate
...
if __name__ == '__main__':
    ...
    test_dataset = MyDataset(file_path='data/test.json')
    test_loader = DataLoader(test_dataset, batch_size=args.eval_batch_size, shuffle=False,
                             collate_fn=collate.collate_fn)

    trainer = Trainer(args, train_loader, test_loader, test_loader, device)
    # 训练和验证
    trainer.train()
